...
<ul class="c-header-nav d-md-down-none">
    <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="#">@lang('message.dashboard')</a></li>
    <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="#">Users</a></li>
    <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="#">@lang('message.setting')</a></li>
    <li class="c-header-nav-item px-3">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Language({{ session('locale') == 'en' ? 'EN' : 'VI' }})
        </a>
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="{{route('setLocale','en')}}">EN</a></li>
            <li><a class="dropdown-item" href="{{route('setLocale','vi')}}">VI</a></li>
        </ul>
    </li>
</ul>
